<div class="stations index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('map_lat'); ?></th>
			<th><?php echo $this->Paginator->sort('map_long'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($station['Station']['map_lat']); ?>&nbsp;</td>
		<td><?php echo h($station['Station']['map_long']); ?>&nbsp;</td>
		<td class="actions">
